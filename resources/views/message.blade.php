...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
	...
	<tr><td align="center" bgcolor="#fbfcfd">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr><td>
			    Dear <h3>{{ $fullname }}<h3><br>
			    
			    <font face="Arial, Helvetica, sans-serif" size="1" color="#57697e" style="font-size: 12px;">
			   <p>Greetings!</p>
			    Welcome to Swvy:<br>
			    
				<center><a href="{{ url('api/verify-email/'.$email) }}"><strong> Click here to verify your email</strong></a></center>
			    </p>
			    
			    <p>
			        Support: support@goswyv.com |
					General email: hello@goswyv.com |
			        Swvy Team<br/>
			    </p>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center" style="padding:20px;flaot:left;width:100%; text-align:center;">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					Copyrights © <?php echo date('Y') ?> Swvy. All Rights Reserved
				</span></font>				
			</td></tr>			
		</table>
	</td></tr>
